...
public class UserPerformanceInfoServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        try {
            plist = performanceService.userPerformanceInfo(employee_id);
        ...
        // 3.请求转发
        request.getRequestDispatcher("/userPerformance.jsp").forward(request, response);
    }
