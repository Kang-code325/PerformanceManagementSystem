...
public class AdminEditPerFoServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            performance = performanceService.getOneAdminProgress(id);
        ...
        request.getRequestDispatcher("/AdminUpdateProformance.jsp").forward(request, response);
    }
}
